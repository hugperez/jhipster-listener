...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTITYHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTITYHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTITYHISTORY actions', async () => {
      const arg = { id: 9468 };
    ...
    it('dispatches UPDATE_ENTITYHISTORY actions', async () => {
      const arg = { id: 9468 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTITYHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTITYHISTORY actions', async () => {
      const arg = 42666;
