...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './entity-b.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTITYB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTITYB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTITYB actions', async () => {
      const arg = { id: 21908 };
    ...
    it('dispatches UPDATE_ENTITYB actions', async () => {
      const arg = { id: 21908 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTITYB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTITYB actions', async () => {
      const arg = 42666;
