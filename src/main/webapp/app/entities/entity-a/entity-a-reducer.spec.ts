...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './entity-a.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTITYA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTITYA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTITYA actions', async () => {
      const arg = { id: 32006 };
    ...
    it('dispatches UPDATE_ENTITYA actions', async () => {
      const arg = { id: 32006 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTITYA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTITYA actions', async () => {
      const arg = 42666;
